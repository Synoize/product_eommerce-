    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white md:border md:rounded-2xl md:shadow-sm md:p-10 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Shipping Info -->
                <div class="text-left mb-8">
                    <h5 class="font-bold text-gray-900 mb-4">Shipping</h5>
                ...
                <!-- Payment Info -->
                <div class="text-left mb-8">
                    <h5 class="font-bold text-gray-900 mb-4">Payment</h5>
                    ...
                    <?php if ($order['payment_method'] === 'cod'): ?>
                        <!-- COD Payment Details -->
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-3 text-sm">
